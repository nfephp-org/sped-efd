...
$std->VL_TOT_DEBITOS_DIFAL = 620.00;
$std->VL_OUT_DEB_DIFAL = 45.50;
$std->VL_TOT_CREDITOS_DIFAL = 509.00;
$std->VL_OUT_CRED_DIFAL = 50.00;
$std->VL_SLD_DEV_ANT_DIFAL = 4.60;//0;
$std->VL_DEDUCOES_DIFAL = 4.50;
