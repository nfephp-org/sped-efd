...
class BlocoK extends Bloco
{
     ...
     * @param bool $comDados
     */
    public function setK001($comDados = true)
    {
        $this->K001 = "|K001|0|\n";
        if (! $comDados) {
            $this->K001 = "|K001|1|\n";
     ...
     * @param string $dtFin
     */
    public function setK100($dtIni = '', $dtFin = '')
    {
        $this->dtIni = $dtIni;
        $this->dtFin = $dtFin;
     ...
     * );
     */
    public function setK200($aDados = array())
    {
     ...
     * @param array $aDados
     */
    public function setK220($aDados = array())
    {
     ...
     * @param array $aDados
     */
    public function setK230($aDados = array())
    {
     ...
     * @param array $aDados
     */
    public function setK235($aDados = array())
    {
     ...
     * @param array $aDados
     */
    public function setK250($aDados = array())
    {
     ...
     * @param array $aDados
     */
    public function setK255($aDados = array())
    {
