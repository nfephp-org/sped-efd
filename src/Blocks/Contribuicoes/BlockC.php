...
final class BlockC extends Block implements BlockInterface
{
    public $elements = [
        ...
        'c100' => ['class' => Elements\C100::class, 'level' => 3, 'type' => 'multiple'],
        'c110' => ['class' => Elements\C110::class, 'level' => 4, 'type' => 'multiple'],
        ...
        'c180' => ['class' => Elements\C180::class, 'level' => 3, 'type' => 'multiple'],
        ...
        'c198' => ['class' => Elements\C198::class, 'level' => 4, 'type' => 'multiple'],
        'c199' => ['class' => Elements\C199::class, 'level' => 4, 'type' => 'multiple'],
        'c380' => ['class' => Elements\C380::class, 'level' => 3, 'type' => 'multiple'],
        'c381' => ['class' => Elements\C381::class, 'level' => 4, 'type' => 'multiple'],
        'c385' => ['class' => Elements\C385::class, 'level' => 4, 'type' => 'multiple'],
        'c395' => ['class' => Elements\C395::class, 'level' => 3, 'type' => 'multiple'],
        'c396' => ['class' => Elements\C396::class, 'level' => 4, 'type' => 'multiple'],
        ...
        'c489' => ['class' => Elements\C489::class, 'level' => 4, 'type' => 'multiple'],
        ...
        'c505' => ['class' => Elements\C505::class, 'level' => 4, 'type' => 'multiple'],
        'c509' => ['class' => Elements\C509::class, 'level' => 4, 'type' => 'multiple'],
        'c600' => ['class' => Elements\C600::class, 'level' => 3, 'type' => 'multiple'],
        'c601' => ['class' => Elements\C601::class, 'level' => 4, 'type' => 'multiple'],
        'c605' => ['class' => Elements\C605::class, 'level' => 4, 'type' => 'multiple'],
        'c609' => ['class' => Elements\C609::class, 'level' => 4, 'type' => 'multiple'],
        'c800' => ['class' => Elements\C800::class, 'level' => 3, 'type' => 'multiple'],
        ...
        'c870' => ['class' => Elements\C870::class, 'level' => 4, 'type' => 'multiple'],
