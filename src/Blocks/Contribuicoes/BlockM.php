...
final class BlockM extends Block implements BlockInterface
{
    public $elements = [
        ...
        'm105' => ['class' => Elements\M105::class, 'level' => 3, 'type' => 'multiple'],
        ...
        'm210' => ['class' => Elements\M210::class, 'level' => 3, 'type' => 'multiple'],
        'm211' => ['class' => Elements\M211::class, 'level' => 3, 'type' => 'multiple'],
        ...
        'm350' => ['class' => Elements\M350::class, 'level' => 2, 'type' => 'multiple'],
        'm400' => ['class' => Elements\M400::class, 'level' => 2, 'type' => 'multiple'],
        'm410' => ['class' => Elements\M410::class, 'level' => 3, 'type' => 'multiple'],
        'm500' => ['class' => Elements\M500::class, 'level' => 2, 'type' => 'multiple'],
        'm505' => ['class' => Elements\M505::class, 'level' => 3, 'type' => 'multiple'],
        'm510' => ['class' => Elements\M510::class, 'level' => 3, 'type' => 'multiple'],
        'm515' => ['class' => Elements\M515::class, 'level' => 4, 'type' => 'multiple'],
        ...
        'm611' => ['class' => Elements\M611::class, 'level' => 4, 'type' => 'multiple'],
        'm615' => ['class' => Elements\M615::class, 'level' => 4, 'type' => 'multiple'],
        ...
        'm700' => ['class' => Elements\M700::class, 'level' => 2, 'type' => 'multiple'],
        'm800' => ['class' => Elements\M800::class, 'level' => 2, 'type' => 'multiple'],
        'm810' => ['class' => Elements\M810::class, 'level' => 3, 'type' => 'multiple'],
    ];
}
