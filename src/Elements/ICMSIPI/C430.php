    ...
    const PARENT = 'C370';
     ...
     protected $parameters = [
        ...
        'VL_UNIT_ICMS_NA_OPERACAO_CONV' => [
            ...
            'regex'    => '^\d+(\.\d*)?|\.\d+$',
            'required' => true,
            'info'     => 'Valor unitário para o ICMS na operação, caso não houvesse a ST, considerando unidade utilizada para informar o campo QUANT_CONV, aplicando-se a mesma redução da base de cálculo do ICMS ST na tributação, se houver',
            'format'   => '15v6'
        ],
        'VL_UNIT_ICMS_OP_CONV' => [
            ...
            'regex'    => '^\d+(\.\d*)?|\.\d+$',
            'required' => true,
            'info'     => 'Valor unitário correspondente ao ICMS OP utilizado no cálculo do ressarcimento / restituição, no desfazimento da substituição tributária, calculado conforme a legislação de cada UF, considerando a unidade utilizada para informar o campo QUANT_CONV.',
            'format'   => '15v6'
        ],
        ...
        'VL_UNIT_ICMS_ST_ESTOQUE_CONV' => [
            ...
            'regex'    => '^\d+(\.\d*)?|\.\d+$',
            'required' => true,
            'info'     => 'Valor médio unitário do ICMS/ST, incluindo FCP ST, das mercadorias em estoque, considerando unidade utilizada para informar o campo QUANT_CONV.',
            'format'   => '15v6'
        ],
        'VL_UNIT_FCP_ICMS_ST_ESTOQUE_CONV' => [
            ...
            'regex'    => '^\d+(\.\d*)?|\.\d+$',
            'required' => true,
            'info'     => 'Valor médio unitário do FCP ST agregado ao ICMS das mercadorias em estoque, considerando unidade utilizada para informar o campo QUANT_CONV.',
            'format'   => '15v6'
        ],
