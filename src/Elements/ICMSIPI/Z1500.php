...
class Z1500 extends Element implements ElementInterface
{
    ...
    public function postValidation()
    {
        ...
        if ($this->std->num_doc <= 0) {
            throw new \InvalidArgumentException("[" . self::REG . "] O valor informado no campo NUM_DOC deve ser maior que “0” (zero).");
        }
        ...
        if ($this->std->vl_doc <= 0) {
            throw new \InvalidArgumentException("[" . self::REG . "] O valor informado no campo VL_DOC deve ser maior que “0” (zero).");
        }
        ...
        if ($this->std->vl_forn <= 0) {
            throw new \InvalidArgumentException("[" . self::REG . "] O valor informado no campo VL_FORN deve ser maior que “0” (zero).");
        }
    }
}
