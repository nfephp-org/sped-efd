...
class M515 extends Element implements ElementInterface
{
    const REG = 'M515';
    const LEVEL = 4;
    const PARENT = 'M510';
    ...
    protected $parameters = [
        'DET_VALOR_AJ' => [
            ...
            'regex' => '^\d+(\.\d*)?|\.\d+$',
            'required' => false,
            'info' => 'Detalhamento do valor do crédito reduzido ou acrescido, informado no Campo 03 (VL_AJ) do ' .
                'registro M510. ',
            'format' => '15v2'
        ],
        'CST_COFINS' => [
        ...
        'DET_BC_CRED' => [
            ...
            'regex' => '^\d+(\.\d*)?|\.\d+$',
            'required' => false,
            'info' => 'Detalhamento da base de cálculo geradora de ajuste de crédito ',
            'format' => '15v3'
        ],
        'DET_ALIQ' => [
            'type' => 'numeric',
            'regex' => '^\d+(\.\d*)?|\.\d+$',
            'required' => false,
            'info' => 'Detalhamento da alíquota a que se refere o ajuste de crédito ',
            'format' => '8v4'
        ],
        'DT_OPER_AJ' => [
            'type' => 'string',
