...
class Z0111 extends Element implements ElementInterface
{
    ...
    protected $parameters = [
        ...
        'REC_BRU_NCUM_NT_MI' => [
            ...
            'regex' => '^\d+(\.\d*)?|\.\d+$',
            'required' => false,
            'info' => 'Receita Bruta Não-Cumulativa – Não Tributada no Mercado Interno (Vendas com suspensão, alíquota zero, isenção e sem incidência das contribuições)',
            'format' => '15v2'
        ],
        'REC_BRU_NCUM_EXP' => [
            'type' => 'numeric',
    ...
    public function postValidation()
    {
        ...
        if($this->values->rec_bru_total!=$somatorio){
            throw new \InvalidArgumentException("[" . self::REG . "] " .
                " A soma dos valores dos campos 02, 03, 04 e 05 deve ser igual ao valor informado no campo REC_BRU_TOTAL.");
        }
    }
}
